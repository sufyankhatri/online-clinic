...
<body>
	...
	<form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
		...
		First Name <input class="sg" type="text" name="Firstname" required="required" value="Username">	Last Name <input class="sg" type="text" name="Lastname" required="required"><br>
